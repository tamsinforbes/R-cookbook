...
As well as the atomic vector types you will often encounter three other vector
types; **factors**, **dates** and **date-times**.  Here we will briefly discuss
factors and dates, leaving further discussion of date-times to chapter 
\@ref(dates).
