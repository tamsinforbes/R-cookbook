...
knitr::kable(head(dplyr::select(road_accidents, acc_index, Date, Police_Force, Accident_Severity, Day_of_Week, Time)),
...
road_accidents$date <- 
paste(road_accidents$Year, road_accidents$Month, road_accidents$Day, sep="-") %>% ymd() %>% as.Date()
