...
```{r 10, echo = TRUE, eval = TRUE, error = FALSE, warning = FALSE}
...
```{r 9, echo = TRUE, eval = FALSE, error = FALSE}
...
```{r 7, echo = TRUE, eval = FALSE, error = FALSE, warning = FALSE}
LAs %>%
...
```{r 6, echo = TRUE, eval = FALSE, error = FALSE, warning = TRUE}
tmap_mode("view")
...
```
``` {r 5, echo = FALSE, eval = TRUE, error = FALSE, warning = TRUE}
...
```{r 4, echo = TRUE, eval = FALSE, error = FALSE, warning = TRUE}
