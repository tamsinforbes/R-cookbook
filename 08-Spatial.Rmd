...
LAs %>% dplyr::group_by(country) %>% dplyr::tally()
```
...
LAs_casualties %>% dplyr::arrange(desc(casualties))
...
```{r 10, echo = FALSE, eval = TRUE, error = FALSE}
LAs %>% dplyr::filter(lad19nm == "Cornwall") %>% tmap::qtm()
```
...
```{r 9, echo = TRUE, eval = TRUE, error = FALSE}
...
```{r 8, echo = FALSE, eval = TRUE}
Cornwall1 <- LAs %>% dplyr::filter(lad19nm == "Cornwall") %>% tmap::qtm(title = "Original")
#Cornwall2 <- LAs_simp %>% dplyr::filter(lad19nm == "Cornwall") %>% tmap::qtm(title = "5%")

#tmap::tmap_arrange(Cornwall1, Cornwall2)
```
...
```{r 7, echo = TRUE, eval = TRUE, error = FALSE, warning = FALSE}
...
```{r 6, echo = TRUE, eval = TRUE, error = FALSE, warning = FALSE}
LAs %>%
...
```{r 5, echo = TRUE, eval = TRUE, error = FALSE, warning = TRUE}
tmap_mode("view")
...
```{r 4, echo = TRUE, eval = TRUE, error = FALSE, warning = TRUE}
...
```{r 3, echo = TRUE, eval = TRUE, error = FALSE, warning = TRUE}
...
```{r 2, echo = TRUE, eval = FALSE, error = FALSE, warning = TRUE}
