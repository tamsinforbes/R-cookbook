...
```
```{r, echo = TRUE, eval = FALSE, error = FALSE, message = FALSE}
summary(LAs_pop)
```
...
```{r 10, echo = FALSE, eval = FALSE, error = FALSE}
...
```{r 6, echo = TRUE, eval = FALSE, error = FALSE, warning = FALSE}
LAs %>%
